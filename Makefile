...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Thu Feb 7 10:42:57 2013
...
SOURCES       = src/Edge.cpp \
		...
		src/math/Point.cpp temp/moc_GLWidget.cpp \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) obj/release/trab\ final1.0.0/ && $(COPY_FILE) --parents src/BoundingBox.h src/Edge.h src/Face.h src/HalfEdge.h src/Loop.h src/Mesh.h src/Scene.h src/Vertex.h src/interface/GLWidget.h src/interface/mainwindow.h src/interface/trackball.h src/math/Quat.h src/math/Vec3.h src/interface/dialogcube.h src/interface/dialogcorner.h src/interface/dialogcylinder.h src/interface/dialogsphere.h src/interface/dialogsweeping.h src/interface/dialogedit.h src/interface/dialogrotate.h src/bezier.h src/math/Point3D.h src/math/Point.h obj/release/trab\ final1.0.0/ && $(COPY_FILE) --parents data/icon/icons.qrc obj/release/trab\ final1.0.0/ && $(COPY_FILE) --parents src/Edge.cpp src/Face.cpp src/HalfEdge.cpp src/Loop.cpp src/Mesh.cpp src/Scene.cpp src/Vertex.cpp src/interface/GLWidget.cpp src/interface/main.cpp src/interface/mainwindow.cpp src/interface/trackball.cpp src/math/Quat.cpp src/math/Vec3.cpp src/interface/dialogcube.cpp src/interface/dialogcorner.cpp src/interface/dialogcylinder.cpp src/interface/dialogsphere.cpp src/interface/dialogsweeping.cpp src/interface/dialogedit.cpp src/interface/dialogrotate.cpp src/bezier.cpp src/math/Point3D.cpp src/math/Point.cpp obj/release/trab\ final1.0.0/ && $(COPY_FILE) --parents src/interface/mainwindow.ui src/interface/dialogcube.ui src/interface/dialogcorner.ui src/interface/dialogcylinder.ui src/interface/dialogsphere.ui src/interface/dialogsweeping.ui src/interface/dialogedit.ui src/interface/dialogrotate.ui obj/release/trab\ final1.0.0/ && (cd `dirname obj/release/trab\ final1.0.0` && $(TAR) trab\ final1.0.0.tar trab\ final1.0.0 && $(COMPRESS) trab\ final1.0.0.tar) && $(MOVE) `dirname obj/release/trab\ final1.0.0`/trab\ final1.0.0.tar.gz . && $(DEL_FILE) -r obj/release/trab\ final1.0.0
